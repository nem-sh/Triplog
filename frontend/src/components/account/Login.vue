...
export default {
  ...
  data() {
    return {
      ...
      alertMsg: "",
      password_confirm: "",
      kakaoUrl:`https://kauth.kakao.com/oauth/authorize?client_id=4b566a63a487519e52bcd20aec5f9326&redirect_uri=http://localhost:8080/api/social/kakao/code&response_type=code&state=${this.$route.query.redirect}`,
