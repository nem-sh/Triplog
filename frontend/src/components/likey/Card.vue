  ...
  <v-col cols="12" :md="size === 2 ? 6 : size === 3 ? 4 : undefined">
    <v-hover v-slot:default="{ hover }">
      <v-card
        ...
        href="#!"
      >
        <v-img :src="require(`@/assets/blogImage/${value.article.thumbnail}`)" height="100%" @click.stop="dialog = true">
          <!-- modal str-->
          ...
          <v-dialog v-model="dialog" max-width="688">
            <v-card @click="dialog = false" class="mx-auto" style="opacity: 1; ">
              ...
              <v-img :src="require(`@/assets/blogImage/${value.article.thumbnail}`)" height="388"></v-img>
              <br />
