<template>
  <div style="min-width: 1000px;" id="main_wrap">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <v-btn type="button" @click="onClickImageUpload">Find Image</v-btn>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <br/>
              <v-textarea label="내용을 입력하세요" auto-grow outlined rows="1" row-height="500" id="content" ref="content" v-model="articleContent"></v-textarea>
            </td>
          </tr>
        </tbody>
      </template>
    ...
    <div>
      <v-btn style="float: left;" @click="temp">임시 저장</v-btn>
      <v-btn style="float: right;" @click="regist">등록</v-btn>
    </div>
    <br/><br/><br/><br/>
